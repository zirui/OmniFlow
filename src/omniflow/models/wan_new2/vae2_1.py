...
Minimal changes:
- add small `to()/eval()/train()` helpers on the wrapper to fit OmniFlow usage
...
class Wan2_1_VAE:
    ...
    # --- OmniFlow compatibility helpers (non-upstream) ---
...
# Backward-compat alias (OmniFlow older naming)
WanVAE = Wan2_1_VAE
