...
export DOCKER_IMAGE=${DOCKER_IMAGE:-zirui3/primus-v26.3-flux:v0.4.3}
...
env_names=(
    ...
    FSDP2_RESHARD_AFTER_FORWARD FSDP2_REDUCE_DTYPE FLUX_FP8_ALL_GATHER FSDP2_FORCE_SUM
    ...
    NCCL_MIN_NCHANNELS NCCL_MAX_NCHANNELS NCCL_NTHREADS NCCL_ALGO NCCL_PROTO
