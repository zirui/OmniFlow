...
forward_vars=(
    ...
    FLUX_FLOAT8_RECIPE FLUX_FP8_GEMM_BACKEND ATTENTION_BACKEND LOCAL_BATCH_SIZE EVAL_BATCH_SIZE
...
exec srun "${srun_args[@]}" env -u NODE_RANK "${env_args[@]}" bash "$SCRIPT_DIR/run_with_docker.sh"
